...
#The import of Kernel module is necessary in order to be able to use
...
for e in dt.edges: pass
vertices = {}
for i in range(20):
    # we generate a random points and insert them in the dt triangulation
    vertices[i] = dt.insert(Point_2(random(),random()))  

# use of the incident_faces function
# cir_faces is circulator over the incident faces of the Vertex vertices[0]
cir_faces = dt.incident_faces(vertices[0]) 
