...
double Navier::DUU(double LL, double L, double M, double R, double RR, 
                       double DD, double D, double DP, double PP, double alpha, int border) 
{
...
double Navier::DUV(double LL, double L, double M, double R, double RR, double KL, double KR, double DD, double DM, double D, double DP, double PP, double alpha, int border) {
